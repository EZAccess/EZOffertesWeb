...
{
    public class PurchaseOrdersBase : ComponentBase
    {
        ...
        //protected SfGrid<> DefaultGrid;

        protected void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
        {
